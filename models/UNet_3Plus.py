...
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, in_channels=1, n_classes=1, feature_scale=64, is_deconv=True, is_batchnorm=True):
...
class UNet_3Plus_DeepSup(nn.Module):
    def __init__(self, in_channels=1, n_classes=1, feature_scale=32, is_deconv=True, is_batchnorm=True):
