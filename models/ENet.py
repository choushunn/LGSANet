...
class InitialBlock(nn.Module):
    def __init__(self, in_channels, out_channels, bias=False, relu=True):
        ...
        if (relu):
            ...
            activation = nn.PReLU
        # 主分支
        self.main_branch = nn.Conv2d(in_channels, out_channels - in_channels, kernel_size=3, stride=2, padding=1, bias=bias)
        # 分支
...
class ENet(nn.Module):
    def __init__(self, in_channels=3, num_classes=16, encoder_relu=False, decoder_relu=True):
        super(ENet, self).__init__()
        ##256x256
        self.initial_block = InitialBlock(in_channels=in_channels, out_channels=16, relu=encoder_relu)
        ...
        self.asymmetric3_2 = Bottleneck(128, kernel_size=5, padding=2, asymmetric=True, dropout_prob=0.1,
                                        relu=encoder_relu)
        ...
        self.asymmetric3_6 = Bottleneck(128, kernel_size=5, asymmetric=True, padding=2, dropout_prob=0.1,
                                        relu=encoder_relu)
...
if __name__ == "__main__":
    net = ENet(num_classes=1, in_channels=2, encoder_relu=False, decoder_relu=True)
    # model.eval()
    inputs = torch.randn(1, 2, 512, 512)
    output = net(inputs)
    print(output.size())
    from torchinfo import summary
    summary(net, (1,2, 1080, 1920),device='cpu')

# summary(net, (2, 512, 512))
# ==========================================================================================
# Total params: 348,969
# Trainable params: 348,969
# Non-trainable params: 0
# Total mult-adds (G): 1.97
# ==========================================================================================
# Input size (MB): 2.00
# Forward/backward pass size (MB): 761.00
# Params size (MB): 1.33
# Estimated Total Size (MB): 764.33
# ==========================================================================================
