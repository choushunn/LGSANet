...
class DC_Unet(torch.nn.Module):
    def __init__(self, in_channels=3, out_channels=1, nf=16, use_dropout=False):
...
if __name__ == '__main__':
    net = DC_Unet(in_channels=2, nf=32)
    # x = torch.randn(1, 2, 1080, 1920)
    # y = net(x)
    # print(y.shape)
    from torchinfo import summary
    summary(net, (1,2, 1072, 1920), device="cpu")

# DC_Unet(in_channels=2, nf=32)
# ===============================================================================================
# Total params: 10,810,876
# Trainable params: 10,810,876
# Non-trainable params: 0
# Total mult-adds (G): 77.64
# ===============================================================================================
# Input size (MB): 2.00
# Forward/backward pass size (MB): 3643.02
# Params size (MB): 41.24
# Estimated Total Size (MB): 3686.26
# ===============================================================================================
