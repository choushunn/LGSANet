...
class R2AttU_Net(nn.Module):
    ...
    def __init__(self, in_channels=1, out_ch=1, t=2, nf=64):
        super(R2AttU_Net, self).__init__()

        # n1 = 64
        filters = [nf, nf * 2, nf * 4, nf * 8, nf * 16]
...
class NestedUNet(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=1, nf=32):
...
if __name__ == '__main__':
    # net = NestedUNet(in_ch=2)
    net = R2AttU_Net(in_channels=2, nf=32)
    # print(net)

    # x = torch.randn(1, 1, 1072, 1920)
    # y = net(x)
    # print(y.shape)
    from torchinfo import summary

    summary(net, (1, 2, 512, 512), device='cpu')

# NestedUNet(in_ch=2)
# ==========================================================================================
# Total params: 9,163,041
# Trainable params: 9,163,041
# Non-trainable params: 0
# Total mult-adds (G): 137.88
# ==========================================================================================
# Input size (MB): 2.00
# Forward/backward pass size (MB): 2066.00
# Params size (MB): 34.95
# Estimated Total Size (MB): 2102.95
# ==========================================================================================


# R2AttU_Net(in_ch=2, nf=32)
# ===============================================================================================
# Total params: 9,868,621
# Trainable params: 9,868,621
# Non-trainable params: 0
# Total mult-adds (G): 154.12
# ===============================================================================================
# Input size (MB): 2.10
# Forward/backward pass size (MB): 3971.28
# Params size (MB): 39.47
# Estimated Total Size (MB): 4012.86
# ===============================================================================================
